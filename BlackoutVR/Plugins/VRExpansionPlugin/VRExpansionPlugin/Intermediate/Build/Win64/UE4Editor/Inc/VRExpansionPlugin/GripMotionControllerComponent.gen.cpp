...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UGripMotionControllerComponent()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				MetaData->SetValue(OuterClass, TEXT("ToolTip"), TEXT("An override of the MotionControllerComponent that implements position replication and Gripping with grip replication and controllable late updates per object."));
	...
	IMPLEMENT_CLASS(UGripMotionControllerComponent, 3202012139);
